...
import { registerRenderCommands, renderCommand } from "../src/index";
import { renderExportCommand } from "../src/render";
...
vi.mock("@riotprompt/riotplan-renderer", () => ({
